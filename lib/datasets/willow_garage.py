...
class willow_garage(datasets.imdb):
    def __init__(self, image_set, year, devkit_path=None):
        datasets.imdb.__init__(self, 'willow_garage_' + year + '_' + image_set)
        self._year = year
	...
	self._classes = ('__background__', # always index 0
        ...
        assert os.path.exists(self._devkit_path), \
                'WillowGaragedevkit path does not exist: {}'.format(self._devkit_path)
    ...
    def _get_default_path(self):
        """
        Return the default path where WillowGarage is expected to be installed.
        """
        return os.path.join(datasets.ROOT_DIR, 'data', 'WillowGarageDataset' + self._year)
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_willow_garage_annotation(index)
    ...
    def _load_willow_garage_annotation(self, index):
        """
        Load image and bounding boxes info from annotation file.
        """
    ...
    def _write_willow_garage_results_file(self, all_boxes):
        ...
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} Willow Garage results file'.format(cls)
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        comp_id = self._write_willow_garage_results_file(all_boxes)
...
if __name__ == '__main__':
    d = datasets.willow_garage('train', '2011')
    res = d.roidb
